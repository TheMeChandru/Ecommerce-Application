  ...
  return (
    <div style={{zIndex:999}} className={`${showSidebar ? 'hidden' : 'flex'} xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed`} id="navigation-container">
      <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="span hidden nav-item-name mt-[3rem]">Shopping</div>
            </Link>
            ...
            <div className="span hidden nav-item-name mt-[3rem]">Favorite
              <FavoritesCount/>
            </div>
            </Link>
      </div>
      <div className="relative">
        ...
        {!userInfo && (
            ...
            <Link to='/register' className='flex items-center transition-transform transform hover:translate-x-2'>
                ...
                <div className="span hidden nav-item-name mt-[3rem]">Register</div>
                </Link>
            </li>
          </ul>
        )} 
